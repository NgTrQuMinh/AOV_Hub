    ...
    if (!isLoggedIn()) {
        formBox.innerHTML = `
            <div class="feed-form feed-form--guest">
                ...
                <a class="btn btn-primary" href="/pages/login.html?redirect=/pages/feed.html">Đăng nhập</a>
            </div>
        `;
        return;
    }
            ...
            <header class="post-card__head">
                ...
                <div>
                    ...
                    <span class="post-card__meta">
                        ...
                        ${hero ? ` · <a href="/pages/hero-detail.html?id=${hero.id}">${escapeHtml(hero.name)}</a>` : ''}
                    </span>
                </div>
